...
public class EnrollVoiceResponseEntity : Codable {
    // properties
    public var success: Bool = false
    public var status: Int16 = 0
    public var data: EnrollVoiceResponseDataEntity = EnrollVoiceResponseDataEntity()
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.data = try container.decodeIfPresent(EnrollVoiceResponseDataEntity.self, forKey: .data) ?? EnrollVoiceResponseDataEntity()
    }
}

public class EnrollVoiceResponseDataEntity : Codable {
    // properties
