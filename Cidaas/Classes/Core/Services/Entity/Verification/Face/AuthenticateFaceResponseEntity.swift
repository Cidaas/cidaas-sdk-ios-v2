...
public class AuthenticateFaceResponseEntity : Codable {
    // properties
    public var success: Bool = false
    public var status: Int16 = 0
    public var data: AuthenticateFaceResponseDataEntity = AuthenticateFaceResponseDataEntity()
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.data = try container.decodeIfPresent(AuthenticateFaceResponseDataEntity.self, forKey: .data) ?? AuthenticateFaceResponseDataEntity()
    }
}

public class AuthenticateFaceResponseDataEntity : Codable {
    // properties
