...
public class EnrollTouchResponseEntity : Codable {
    // properties
    public var success: Bool = false
    public var status: Int16 = 0
    public var data: EnrollTouchResponseDataEntity = EnrollTouchResponseDataEntity()
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.data = try container.decodeIfPresent(EnrollTouchResponseDataEntity.self, forKey: .data) ?? EnrollTouchResponseDataEntity()
    }
}
