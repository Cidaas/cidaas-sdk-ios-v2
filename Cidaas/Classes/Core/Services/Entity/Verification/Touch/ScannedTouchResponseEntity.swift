...
public class ScannedTouchResponseEntity : Codable {
    // properties
    public var success: Bool = false
    public var status: Int16 = 0
    public var data: ScannedTouchResponseDataEntity = ScannedTouchResponseDataEntity()
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.data = try container.decodeIfPresent(ScannedTouchResponseDataEntity.self, forKey: .data) ?? ScannedTouchResponseDataEntity()
    }
}

public class ScannedTouchResponseDataEntity : Codable {
    // properties
