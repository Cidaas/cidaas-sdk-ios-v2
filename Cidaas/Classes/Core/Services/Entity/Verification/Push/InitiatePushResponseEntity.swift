...
public class InitiatePushResponseEntity : Codable {
    // properties
    public var success: Bool = false
    public var status: Int16 = 0
    public var data: InitiatePushResponseDataEntity = InitiatePushResponseDataEntity()
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.data = try container.decodeIfPresent(InitiatePushResponseDataEntity.self, forKey: .data) ?? InitiatePushResponseDataEntity()
    }
}

public class InitiatePushResponseDataEntity : Codable {
    // properties
