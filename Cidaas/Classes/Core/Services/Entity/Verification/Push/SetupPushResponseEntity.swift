...
public class SetupPushResponseEntity : Codable {
    // properties
    public var success: Bool = false
    public var status: Int16 = 0
    public var data: SetupPushResponseDataEntity = SetupPushResponseDataEntity()
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.data = try container.decodeIfPresent(SetupPushResponseDataEntity.self, forKey: .data) ?? SetupPushResponseDataEntity()
    }
}
