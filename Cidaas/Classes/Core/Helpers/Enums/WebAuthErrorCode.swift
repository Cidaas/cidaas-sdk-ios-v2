...
public enum WebAuthErrorCode : Int32 {
    ...
    case TOUCH_ID_PASSCODE_NOT_CONFIGURED = 10180
    case TOUCH_ID_INVALID_AUTHENTICATION = 10181
    case TOUCH_ID_APP_CANCELLED = 10182
    case TOUCH_ID_SYSTEM_CANCELLED = 10183
    case TOUCH_ID_USER_CANCELLED = 10184
