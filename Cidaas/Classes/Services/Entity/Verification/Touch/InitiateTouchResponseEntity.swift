...
public class InitiateTouchResponseEntity : Codable {
    // properties
    public var success: Bool = false
    public var status: Int16 = 0
    public var data: InitiateTouchResponseDataEntity = InitiateTouchResponseDataEntity()
    ...
    public required init(from decoder: Decoder) throws {
        ...
        self.data = try container.decodeIfPresent(InitiateTouchResponseDataEntity.self, forKey: .data) ?? InitiateTouchResponseDataEntity()
    }
}

public class InitiateTouchResponseDataEntity : Codable {
    // properties
