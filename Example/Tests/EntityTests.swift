        ...
        describe("Entity Test cases") {
            ...
            context("Entity test") {
                ...
                it("call initiate account verification response entity") {
                    ...
                    let jsonString = "{\"success\":true,\"status\":200,\"data\":{\"email\":\"muthu.va23+20@gmail.com\",\"requestId\":\"5c4da8c3-f9f4-4884-865a-5d79ac24a017\",\"accvid\":\"79b5b070-897e-4ef4-a363-35970d67d637\",\"type\":\"email\",\"processingType\":\"CODE\"}}"
                    let decoder = JSONDecoder()
                    do {
                        let data = jsonString.data(using: .utf8)!
                        // decode the json data to object
